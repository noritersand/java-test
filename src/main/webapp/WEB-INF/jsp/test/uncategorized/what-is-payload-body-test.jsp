...
<body>
	<div class="align-center">
		...
		<form action="/test/uncategorized/read-querystring.data" method="post">
			<fieldset>
		...
		<form action="/test/uncategorized/read-querystring.data" method="post" enctype="application/x-www-form-urlencoded">
			<fieldset>
		...
		<form action="/test/uncategorized/read-querystring.data?1234" method="post" enctype="application/x-www-form-urlencoded">
			<fieldset>
				<legend>sync request: form data #3</legend>
				<button type="submit">SUBMIT</button>
			</fieldset>
		</form>
		<form action="/test/uncategorized/read-body.data" method="post" enctype="multipart/form-data">
			<fieldset>
		...
		<script>
			function send() {
				$.ajax({
					url: '/test/uncategorized/read-querystring.data',
					method: 'post',
					data: 'a=1&b=2',
			...
			function send3() {
				$.ajax({
					url: '/test/uncategorized/read-body.data',
					method: 'post',
					data: 'a=1&b=2',
