...
<ul>
	...
	<li>
		<h4>JavaScript</h4>
		<ul>
			<li><a href="/js-test/array/splice-test.html">array: splice test: 배열의 특정 요소 삭제</a>
			...
			<li><a href="/js-test/statement/for-in-test.js">statement: for in test</a></li>
			...
			<li><a href="/js-test/string/index-of-test.html">statement: indexOf test</a></li>
			<li><a href="/js-test/string/split-join-test.html">statement: split and join</a></li>
		</ul>	
	</li>
	<li>
		<h4>jQuery</h4>
