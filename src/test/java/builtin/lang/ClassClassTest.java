...
class ClassClassTest {
    ...
    @Test
    void testGetPackage() {
        assertEquals("builtin.lang", ClassClassTest.class.getPackage().getName());
    }

    @Test
    void testForName() throws Exception {
        Class<?> cls = Class.forName("builtin.lang.MyClass");
        assertEquals(java.lang.Class.class, cls.getClass());
        assertEquals("builtin.lang.MyClass", cls.getName());
    ...
    void testGetName() {
        ...
        assertEquals("builtin.lang.ClassClassTest$1", new Serializable() {
        }.getClass().getName());
    }
    ...
    void testGetTypeName() {
        ...
        assertEquals("builtin.lang.ClassClassTest$2", new Serializable() {
    ...
    void testCurrentClassName() {
        StackTraceElement[] ste = Thread.currentThread().getStackTrace();
        log.debug(Arrays.toString(ste));
        assertEquals("builtin.lang.ClassClassTest", ste[1].getClassName());
    }
}
