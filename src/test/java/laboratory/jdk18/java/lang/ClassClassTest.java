...
public class ClassClassTest {
	...
	public void testGetPackage() {
		Assert.assertEquals("laboratory.jdk18.java.lang", ClassClassTest.class.getPackage().getName());
	}

	@Test
	public void testForName() throws ClassNotFoundException, InstantiationException, IllegalAccessException {
		Class<?> cls = Class.forName("laboratory.jdk18.java.lang.MyClass");
		Assert.assertEquals(java.lang.Class.class, cls.getClass());
		Assert.assertEquals("laboratory.jdk18.java.lang.MyClass", cls.getName());
	...
	public void testGetName() {
		...
		Assert.assertEquals("laboratory.jdk18.java.lang.ClassClassTest$1", new Serializable() {}.getClass().getName());
	}
	...
	public void testGetTypeName() {
		...
		Assert.assertEquals("laboratory.jdk18.java.lang.ClassClassTest$2", new Serializable() {}.getClass().getTypeName());
	}
	...
	public void testCurrentClassName() {
		final StackTraceElement[] ste = Thread.currentThread().getStackTrace();
		logger.debug(Arrays.toString(ste));
		Assert.assertEquals("laboratory.jdk18.java.lang.ClassClassTest", ste[1].getClassName());
	}
}
