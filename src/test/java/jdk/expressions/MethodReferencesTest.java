...
public class MethodReferencesTest {
	private static final Logger logger = LoggerFactory.getLogger(MethodReferencesTest.class);
...
//		Foo.call(txt, s -> logger.debug(s)); // 아래와 같다.
		Foo.call(txt, (s) -> {
			logger.debug(s);
		});
...
//	    Foo.call(txt, logger::debug;logger::info); // Syntax error on token ";", , expected
	}
